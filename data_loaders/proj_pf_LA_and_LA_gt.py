...
class Dataset_io(Dataset): 
    ...
    def __getitem__(self, index):
        ...
        return temp_LA_ES[:,0,:],temp_LA_ED[:,0,:],proj_2d_ES,proj_2d_ED
...
# plt.figure()
# plt.imshow(a1[9][0,0,0,:])

# proj = a1[9][0,0,0,:].numpy()
# img1 = a1[10][0,0,0,:].numpy()


# temp_ = np.zeros([DIM_,DIM_])
# temp_[np.where((proj>2.2) & (proj <3.2))]=1
