...
def train_fn(loader_train1,loader_valid1,model1, optimizer1, scaler,loss_fn1):  ### Loader_1--> ED and Loader2-->ES
...
#            loss2 = loss_fn(z_mean, z_log_var, recon_batch,all_three_ED)
             ...
             recon_batch = model1(temp_SA_ES)
             loss1 = loss_fn1(recon_batch, temp_LA_ES)
             recon_batch = model1(temp_SA_ED)
             loss2 = loss_fn1(recon_batch,temp_LA_ED)
...
#            recon_batch_ES = act(recon_batch_ES)
            ...
            recon_batch_ES = model1(temp_SA_ES)
            ...
            recon_batch_ED = model1(temp_SA_ED)
   ...
   (out_LA_ES_MYO + temp_LA_ES[:,1:2,:]).sum() + 1e-8)
    ...
    Overall_Dicescore =( Dice_RV + Dice_MYO + Dice_LV ) /3
...
from reg_model1 import Autoencoder_FC
