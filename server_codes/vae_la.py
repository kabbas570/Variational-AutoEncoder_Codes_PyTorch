...
def train_fn(loader_train1,loader_valid1,model1, optimizer1, scaler,loss_fn):  ### Loader_1--> ED and Loader2-->ES
    ...
    for batch_idx, (img_LA_ES,temp_LA_ES,img_SA_ES,temp_SA_ES,img_LA_ED,temp_LA_ED,img_SA_ED,temp_SA_ED,label,M,all_three_ES,all_three_ED,three_ES_SA,three_ED_SA) in enumerate(loop):
       ...
       with torch.cuda.amp.autocast():
            recon_batch, z_mean, z_log_var, _ = model1(all_three_ES)
            loss1 = loss_fn(z_mean, z_log_var, recon_batch,all_three_ES)
            recon_batch, z_mean, z_log_var, _ = model1(all_three_ED)
...
path_to_save_Learning_Curve='/data/scratch/acw676/VAE_weights/'+'/VAE_with_sig'
path_to_save_check_points='//data/scratch/acw676/VAE_weights/'+'/VAE_with_sig'  ##these are weights
