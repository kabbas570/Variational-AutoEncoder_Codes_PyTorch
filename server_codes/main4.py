...
#            loss2 = loss_fn(z_mean, z_log_var, recon_batch,all_three_ED)
             ...
             recon_batch = model1(temp_LA_ES)
             loss1 = loss_fn1(recon_batch, temp_SA_ES)
             recon_batch = model1(temp_LA_ED)
             loss2 = loss_fn1(recon_batch,temp_SA_ED)
...
#            recon_batch_ES = act(recon_batch_ES)
            ...
            recon_batch_ES = model1(temp_LA_ES)
            ...
            recon_batch_ED = model1(temp_LA_ED)
