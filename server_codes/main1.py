...
#            recon_batch_ES = act(recon_batch_ES)
            ...
            single_ES = (2 * (recon_batch_ES * all_three_ES).sum()) / (
                (recon_batch_ES + all_three_ES).sum() + 1e-8)
...
#            recon_batch_ED = act(recon_batch_ED)
            ...
            single_ED = (2 * (recon_batch_ED * all_three_ED).sum()) / (
                (recon_batch_ED + all_three_ED).sum() + 1e-8)
...
path_to_save_Learning_Curve='/data/scratch/acw676/VAE_weights/'+'/Autoencoder_FC_128'
path_to_save_check_points='//data/scratch/acw676/VAE_weights/'+'/Autoencoder_FC_128'  ##these are weights
