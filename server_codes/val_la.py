...
from vae_models import VAE_T,VAE_UpSamp
model_1 = VAE_T()
#model_1 = VAE_UpSamp()

model_1.to(DEVICE)
optimizer = torch.optim.Adam(model_1.parameters(), lr=0)  

path_to_checkpoints = "/data/scratch/acw676/VAE_weights/VAE_T1_bs4.pth.tar"
save_pre_path1 = "/data/home/acw676/VAE/imgs_my1/"
...
for i in range(1):
    plot_images_sampled_from_vae(model=model_1, device=DEVICE, latent_size=8)